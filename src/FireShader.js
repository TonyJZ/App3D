...
function FireMesh(fireTex, color) {
    ...
    // load firetex
    fireTex = fireTex || (function() {
        let loader = new THREE.TextureLoader();
        let fireTex = loader.load("../assets/fire/Fire.png");
        return fireTex;
    }());
...
FireMesh.prototype = Object.create(THREE.Mesh.prototype);
FireMesh.prototype.constructor = FireMesh;

FireMesh.prototype.update = function(timeDelta) {
    this.time += timeDelta;
